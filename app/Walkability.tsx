...
const styles = StyleSheet.create({
  container: { flex: 1, paddingTop: 0, backgroundColor: '#ffffff' },
  content: { padding: 16, paddingBottom: 40, gap: 10 },
  header: { fontSize: 28, marginBottom: 6 },
  ...
  closeBtn: { marginTop: 18, backgroundColor: '#1a73e8', paddingVertical: 12, paddingHorizontal: 16, borderRadius: 10, alignItems: 'center' },
